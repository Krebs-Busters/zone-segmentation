...
if __name__ == "__main__":
    ...
    path = '/home/wolter/uni/cancer/Skyra_Mannheim/Part1/Part1'
    mannheim_scans = load_mannhein(path)
    mannheim_rois = {}
    # extract rois
    for id, images in mannheim_scans.items():
        mannheim_rois[id] = get_roi(images['tra'], images['sag'], images['cor'], input_shape)
    ...
    mannheim_net_segs = {}
    for id, roi in mannheim_rois.items():
