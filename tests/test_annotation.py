"""See it the annotation download is ok."""
...
def test_loading_human_expert_annotations():
    """Fails if the download did not work correctly."""
    files = glob.glob(
        "data/picai_labels/csPCa_lesion_delineations/human_expert/resampled/*.nii.gz"
    )
